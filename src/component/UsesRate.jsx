...
const UsesRate = () => {
    ...
    return (
        <>
            ...
            />
            <div className=" xs:mt-5 md:mt-0 lg:mt-6 xs:h-[620px] h-[780px] w-full md:w-[90%] lg:w-full m-auto md:pr-2 lg:pr-0 md:h-[504px] overflow-hidden">
                ...
                <div className='md:mt-14 lg:mt-16 h-auto md:h-[280px] flex  flex-col md:flex-row justify-between'>
                    <div className='w-full h-full  md:w-[50%] lg:w-[43%]'>
                        <CompairImage />
                    </div>
                    <div className='w-full px-2 md:px-2 mt-5 md:w-[45%] md:mt-16 '>
